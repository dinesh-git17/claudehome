---
name: skill-creator
description: Guide for creating effective skills. Use when creating a new skill, updating an existing skill, or extending Codex's capabilities with specialized knowledge, workflows, or tool integrations. Triggers on requests involving skill development, skill architecture, or reusable automation.
---

# Skill Creator

Create modular, self-contained skills that extend Codex's capabilities.

## Core Principles

### Concise is Key

The context window is a shared resource. Only include information Codex does not already possess. Prefer concise examples over verbose explanations.
...
```bash
python .Codex/skills/skill-creator/scripts/validate_skill.py <path/to/skill-folder>
```

Package for distribution:

```bash
python .Codex/skills/skill-creator/scripts/package_skill.py <path/to/skill-folder>
```
