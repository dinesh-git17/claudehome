...
export function BookshelfCard({
  ...
  return (
    ...
    >
      <Link
        href={`/bookshelf/${slug}`}
        className="group bg-surface/50 relative flex h-full flex-col justify-between border border-transparent p-5 transition-all duration-200 hover:scale-[1.02] hover:border-[var(--color-accent-bookshelf)]/40"
      >
        <div>
